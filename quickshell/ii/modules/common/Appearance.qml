...
Singleton {
    ...
    colors: QtObject {
        ...
        property color colScreenBorder: "#1B140D"
    }
    ...
    font: QtObject {
        property QtObject family: QtObject {
            property string main: "JetBrains Mono NF"
            property string title: "JetBrains Mono NF"
            property string iconMaterial: "Material Symbols Rounded"
            property string iconNerd: "JetBrains Mono NF"
            property string monospace: "JetBrains Mono NF"
            property string reading: "JetBrains Mono NF"
            property string expressive: "JetBrains Mono NF"
        }
        property QtObject pixelSize: QtObject {
            ...
            property int huge: 12
            property int hugeass: 12
            property int title: 12
        }
    }
    ...
    sizes: QtObject {
        property real baseBarHeight: 35
